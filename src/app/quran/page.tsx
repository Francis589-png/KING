    ...
    <div className="container mx-auto py-10">
      <div className="flex flex-col items-center text-center mb-8">
        ...
        <p className="text-muted-foreground max-w-2xl mt-2">
          Select a Sura to study or receive a random verse from the Holy Quran, along with its translation and a brief explanation from King A.J.
        </p>
      </div>
      ...
      <div className="flex justify-center mb-8 gap-4 flex-wrap">
        <Select onValueChange={setSelectedSura} value={selectedSura}>
          ...
          <SelectContent>
            <SelectItem value="">Random Verse</SelectItem>
