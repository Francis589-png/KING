...
/**
 * @fileOverview Summarizes a conversation using Genkit.
 *
...
const SummarizeConversationInputSchema = z.object({
  conversation: z.string().describe('The full conversation history to summarize.'),
});
...
const summarizeConversationPrompt = ai.definePrompt({
  ...
  prompt: `You are King A.J., a helpful and knowledgeable AI assistant. Please summarize the following conversation so a user can quickly catch up on what was discussed. Make sure the summary retains important details of the discussion.
